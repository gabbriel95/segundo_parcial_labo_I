...
{
    int returnAux =-1;
    void* pAuxElementoA = NULL;
    void* pAuxElementoB = NULL;
    int tamanio = ll_len(this);
    ...
    if(this != NULL && pFunc != NULL && (order == 0 || order == 1))
    {
    	for(int i= 0; i<tamanio-1; i++)
    	{
    		...
    		{
    			pAuxElementoA = ll_get(this, i);
    			pAuxElementoB = ll_get(this, j);

    			 if ( ((pFunc(pAuxElementoA,pAuxElementoB) > 0) && order == 1) || ((pFunc(pAuxElementoA,pAuxElementoB) < 0) && order == 0))
				{
					ll_set(this, i, pAuxElementoB);
					ll_set(this, j, pAuxElementoA);
				}
...
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*))
{
	...
	if(this != NULL && pFunc != NULL)
	{
		...
		if(listFilter != NULL)
		{
			for(int i=0; i<tamaniLista; i++)
			{
				if(pFunc(ll_get(this, i)))
				{
					ll_add(listFilter, ll_get(this,i));
				}
			}
		}
	}
